...
/************************************************************/
/*  Function name:          hireEmployee()
/*  Description:            adds new employee to linked list
/*
/*  Parameters:             LinkedList<Employee>& list
/*
/*  Return value:           vois
/*
/*
...
void hireEmployee(LinkedList<Employee>& list){
  ...
  cout << "Please enter employee name: ";
  cin >> name;
  // create employee with inputted name
  Employee Eold(name);

  list.add(Eold);  // add employee to the existing list

} // END of hireEmployee()

/************************************************************/
/*  Function name:          salesSort()
/*  Description:            sorts employees by their sales
/*                          in descending order 
/*  Parameters:             LinkedList<Employee>& list
/*
/*  Return value:           void         
...
/*  Description:            reverses list order
/*
/*  Parameters:             LinkedList<Employee>& list
/*
/*  Return value:           void         
